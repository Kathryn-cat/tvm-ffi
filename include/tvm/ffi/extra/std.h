...
/*! \brief Data object for a lexical scope with carried variables. */
struct ScopeObj : public StmtObj {
  /*! \brief Optional scope attributes. */
  Optional<Attrs> attrs;
  /*! \brief Variables bound by the scope. */
  List<Var> vars;
  ...
  /// \cond Doxygen_Suppress
  ScopeObj() = default;
  ScopeObj(Optional<Attrs> attrs, List<Var> vars, List<Stmt> body)
      : attrs(std::move(attrs)), vars(std::move(vars)), body(std::move(body)) {}

  TVM_FFI_DECLARE_OBJECT_INFO("ffi.std.Scope", ScopeObj, StmtObj);
  /// \endcond
};

/*! \brief Reference wrapper for a lexical scope with carried variables. */
struct Scope : public Stmt {
  /*! \brief Construct a lexical scope. */
  Scope(Optional<Attrs> attrs, List<Var> vars, List<Stmt> body)
...
struct ForObj : public ScopeObj {
  ...
  /// \cond Doxygen_Suppress
  ForObj() = default;
  ForObj(Range range_, Optional<Attrs> attrs, List<Var> vars, List<Stmt> body)
...
struct For : public Scope {
  ...
  For(Range range_, Optional<Attrs> attrs, List<Var> vars, List<Stmt> body)
...
struct WhileObj : public ScopeObj {
  ...
  /// \cond Doxygen_Suppress
  WhileObj() = default;
  WhileObj(Expr cond, Optional<Attrs> attrs, List<Var> vars, List<Stmt> body)
...
struct While : public Scope {
  ...
  While(Expr cond, Optional<Attrs> attrs, List<Var> vars, List<Stmt> body)
...
struct BindObj : public StmtObj {
  ...
  List<Var> vars;
  /*! \brief Optional binding attributes. */
  Optional<Attrs> attrs;

 protected:
  /// \cond Doxygen_Suppress
  BindObj() = default;
  BindObj(List<Var> vars, Optional<Attrs> attrs) : vars(std::move(vars)), attrs(std::move(attrs)) {}
...
struct ExprBindObj : public BindObj {
  /*! \brief Expression being bound. */
  Expr expr;

  /// \cond Doxygen_Suppress
  ExprBindObj() = default;
  ExprBindObj(List<Var> vars, Optional<Attrs> attrs, Expr expr)
      : BindObj(std::move(vars), std::move(attrs)), expr(std::move(expr)) {}

  TVM_FFI_DECLARE_OBJECT_INFO("ffi.std.ExprBind", ExprBindObj, BindObj);
  /// \endcond
};

/*! \brief Reference wrapper for binding an expression to variables. */
struct ExprBind : public Bind {
  /*! \brief Construct an expression binding. */
  ExprBind(List<Var> vars, Optional<Attrs> attrs, Expr expr)
      : ExprBind(make_object<ExprBindObj>(std::move(vars), std::move(attrs), std::move(expr))) {}
  /// \cond Doxygen_Suppress
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(ExprBind, Bind, ExprBindObj);
  /// \endcond
};

/*! \brief Data object for defining variables without a source expression. */
struct VarDefObj : public BindObj {
  /// \cond Doxygen_Suppress
  VarDefObj() = default;
  VarDefObj(List<Var> vars, Optional<Attrs> attrs) : BindObj(std::move(vars), std::move(attrs)) {}

  TVM_FFI_DECLARE_OBJECT_INFO("ffi.std.VarDef", VarDefObj, BindObj);
  /// \endcond
};

/*! \brief Reference wrapper for defining variables without a source expression. */
struct VarDef : public Bind {
  ...
  /// \cond Doxygen_Suppress
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(VarDef, Bind, VarDefObj);
  /// \endcond
};
